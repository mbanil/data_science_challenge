...
def get_args():
    ...
    parser.add_argument("--data_filename", type=str, default="./src/data_repo/data/insurance_claims.csv",
    ...
    parser.add_argument("--schema_path", type=str, default="/src/data_repo/feature_store/")
    ...
    parser.add_argument("--best_hyper_params_filepath", type=str, default='/src/data_repo/best_hyper_params')
